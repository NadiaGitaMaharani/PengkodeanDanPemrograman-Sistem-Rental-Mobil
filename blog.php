                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <?php }?>
                                <li class="list-group-item bg-warning text-dark"><i class="fa fa-check"></i> Free E-toll 50k</li>
                            ...
                            <div class="card-body">
                                <center>
                                    ...
                                    <a href="detail.php?id=<?php echo $isi['id_mobil'];?>" class="btn btn-secondary">Detail</a>
                                </center>
                            </div>
                        </div>
                    </div>
