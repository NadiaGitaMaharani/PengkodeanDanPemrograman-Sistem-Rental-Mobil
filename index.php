            ...
            <div class="card" style=" background: #ddd">
                <div class="card-body">
                    <?php if ($_SESSION['USER']) {?>
                        Welcome , <?php echo $_SESSION['USER']['nama_pengguna'];?>
                        <br/>
                        <br/>
                        <center>
                            ...
                            <?php } else {?>
                                <a href="blog.php" class="btn btn-primary mb-2 btn-block">Booking Now!</a>
                            <?php }?>
                    ...
                    <?php } else {?>
                        <form method="post" action="koneksi/proses.php?id=login">
                            ...
                            <center><button class="btn btn-primary">Log-In</button>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item rp-days">
