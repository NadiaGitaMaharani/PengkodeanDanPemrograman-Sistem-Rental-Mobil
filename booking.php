           ...
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=booking">
                    <div class="form-group">
                      <label for="">ID</label>
                      <input type="text" name="ktp" id="" required class="form-control" placeholder="ID / Driver's License">
                    </div> 
                    <div class="form-group">
                      <label for="">Name</label>
                      <input type="text" name="nama" id="" required class="form-control" placeholder="Your Name">
                    </div> 
                    <div class="form-group">
                      <label for="">Address</label>
                      <input type="text" name="alamat" id="" required class="form-control" placeholder="Address">
                    </div> 
                    <div class="form-group">
                      <label for="">Telephone</label>
                      <input type="text" name="no_tlp" id="" required class="form-control" placeholder="Telephone">
                    </div> 
                    <div class="form-group">
                      <label for="">Rental Date</label>
                      <input type="date" name="tanggal" id="" required class="form-control" placeholder="Date">
                    </div> 
                    <div class="form-group">
                      <label for="">Rental Period</label>
                      <input type="number" name="lama_sewa" id="" required class="form-control" placeholder="How long is the rental?">
                    </div> 
