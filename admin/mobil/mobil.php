        ...
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                ...
                <div class="float-right">
                    <a class="btn btn-success" href="tambah.php" role="button">Add</a>
                </div>
            </h4>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger  btn-sm" href="proses.php?aksi=hapus&id=<?= $isi['id_mobil'];?>&gambar=<?= $isi['gambar'];?>" role="button">Delete</a>  
                            </td>
                        </tr>
                        <?php $no++; }?>
                    </tbody>
