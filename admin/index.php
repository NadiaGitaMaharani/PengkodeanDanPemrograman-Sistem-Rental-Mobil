 ...
 */
    ...
    if(!empty($_POST['nama_rental']))
    {
        ...
        $row->execute($data);
        echo '<script>alert("Website Data Info Update Success!");window.location="index.php"</script>';
        exit;
    }
    ...
    if(!empty($_POST['nama_pengguna']))
    {
        ...
        $row = $koneksi->prepare($sql);
        $row->execute($data);
        echo '<script>alert("Profile Data Update Success!");window.location="index.php"</script>';
        exit;
    }
?>
